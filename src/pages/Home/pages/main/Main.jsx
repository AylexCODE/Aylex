...
import Featured from "../../components/firstComponents/Featured";
...
export default function Main(){
    ...
    return (
        <>
        <div className={`h-fit w-full gap-y-[0.5rem] grid [&>div]:flex [&>div]:flex-col [&>div]:gap-y-[0.5rem] ${breakpoint >= 992 ? "grid-cols-[2fr_1fr]" : "grid-cols-1"} ${breakpoint >= 768 ? "gap-y-[1rem] [&>div>div]:border [&>div>div]:border-borderColor [&>div]:gap-[1rem]" : "[&>div>div]:shadow-[0px_0px_10px_var(--color-navShadowColor)] [&>div]:shadow-[0px_0px_10px_var(--color-navShadowColor)]"}`}>
