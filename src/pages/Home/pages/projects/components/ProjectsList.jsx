...
export default function ProjectsList(props){
    ...
    return (
        <div className="pt-[1rem] w-full">
            <ul ref={projectsList} className="w-full snap-x snap-mandatory h-[20rem] overflow-x-scroll flex flex-row gap-[0.5rem] [&>li]:snap-center [&>li]:block [&>li]:h-full [&>li]:w-[20rem] [&>li]:border [&>li]:border-borderColor [&>li]:rounded-xl [&>li>span]:block [&>li>span]:p-[0.5rem] [&>li>div]:h-[15rem] [&>li>div]:w-[20rem] [&>li>div]:overflow-hidden [&>li>div]:rounded-t-xl [&>li>div>img]:h-full [&>li>div>img]:w-full [&>li>span>p]:first:font-medium">
                <li>
